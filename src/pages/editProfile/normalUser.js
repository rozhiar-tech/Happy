            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex gap-36 mt-5">
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-3xl text-black font-bold">Personal Information</h1>
                       <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                           <div className="flex gap-28 items-center">
                           <p className="text-xl text-black ">First Name</p>
                           <input type="text" placeholder="First Name" className="h-12 w-96 rounded p-2" 
                            value={firstName}
                            ...
                            <input type="text" placeholder="Last Name" className="h-12 w-96 rounded p-2"
                            value={lastName}
                            ...
                            <select className="h-12 w-96 rounded p-2" value={EducationalLevel} onChange={(e)=>setEducationalLevel(e.target.value)}>
                           ...
                           <div className="flex gap-[134px] items-center">
                            ...
                            <input type="text" placeholder="Hobbies" className="h-12 w-96 rounded p-2"
                            value={Hobbies}
                            ...
                            <input type="text"  className="h-12 w-10 rounded p-2"
                            value={familySize}
                            ...
                            <select className="h-12 w-96 rounded p-2" value={gender} onChange={(e)=>setGender(e.target.value)}>
                            ...
                            <input type="date" className="h-12 w-96 rounded p-2"
                            value={birthDate}
                            ...
                            <input type="email" placeholder="Email" className="h-12 w-96 rounded p-2"
                            value={email}
                            ...
                            <input type="text" placeholder="Phone" className="h-12 w-96 rounded p-2"
                            value={phone}
                            ...
                            <input type="password" placeholder="Password" className="h-12 w-96 rounded p-2"
                            value={password}
                            ...
                            <input type="password" placeholder="Confirm Password" className="h-12 w-96 rounded p-2"
