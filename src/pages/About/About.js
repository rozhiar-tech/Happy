    ...
    <div className="flex flex-col">
      <div className="my-20 max-w-6xl mx-auto px-4">
        <div className=" lg:text-left  sm:text-center">
          <h1 className=" mb-2 text-5xl mb-16">Happy!</h1>
      ...
      <div className="md:flex flex-row items-center  justify-center gap-10 bg-light-blue md:px-6 py-8 pb-20 sm:grid sm:grid-cols-1">
        <img
          src={rectangle}
          alt="founder"
          className="md:w-[400px] sm:w-[312px] lg:mx-0 md:mx-auto sm:mx-auto "
        />
        <div className="max-w-2xl lg:mx-0 md:mx-auto sm:mx-auto lg:px-2 md:px-4 sm:px-6">
          <h1 className="mb-4 text-4xl text-gray-700 sm:text-center">
            Our Founding
          </h1>
          <p className="text-gray-900 text-justify text-lg leading-7 lg:pr-6">
            Happy was founded by Payam Abubakr in 2021. It was called Happy
