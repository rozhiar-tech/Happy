    ...
    return(
        <div className="flex flex-col overflow-x-hidden overflow-y-auto ">
            <div className="mt-14 max-w-6xl mx-auto px-4">
                ...
                onClick={handleClick}>SEE OUR OPEN LIST</button>
                </div>
            </div>
            <div className="flex flex-col items-center  justify-center text-gray-700 bg-orange py-6 md:text-left text-center">
                <div className="max-w-6xl lg:mx-0 md:mx-auto sm:mx-auto  px-4">
                    <h1 className="mb-2 text-4xl">OUR HIRING PHILOSOPHY</h1>
                    <p className="leading-8 text-justify text-lg">To build the very best SEO tools, we need a workforce that reflects the diversity of our communities and customers. We want Online Therapy to be a place where everyone feels welcome and engaged, bar none. It&#39;s our mission and promise to interview a diverse and representative slate of candidates before making an offer for our open roles.</p>
                </div>
            </div>
            <Scrolling ref={ref}/> 
        </div>
