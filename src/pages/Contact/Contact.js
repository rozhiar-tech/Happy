...
function Contact() {
  ...
  if (emailStatus === 'error') {
    props = {
      title: 'Error!',
      message:
        'An error has occured. Your message was not sent. Please try again.',
      btnValue: 'Go Back To Contact',
      onHandleClick: () => setEmailStatus(() => 'notSent'),
    };
  }
        ...
        <div className="grid md:grid-cols-2 gap-4 px-4 sm:px-16 break-words w-screen">
          <div className="md:col-span-2">
            ...
            <p className="text-2xl text-black/50 font-medium">
              ...
              you need assistance, please fill out the form below and we&apos;d
              be happy to help!
            </p>
          </div>
