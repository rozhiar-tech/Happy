        ...
        <div className="pt-20 pb-16  max-w-7xl mx-auto" >
            ...
            <div className="cards grid lg:grid-cols-3 md:grid-cols-2 md:px-7 sm:grid-cols-1 sm:px-5 gap-6">
                <div className="card-1 py-6 border border-gray-100  rounded-2xl shadow-xl">
                    ...
                    <p className="text-center mx-12 text-gray-500 leading-7">Feeling ready to start a conversation? Give your therapist a voice call and talk your heart out!</p></NavLink>
                </div>
                <div className="card-2 py-6 border border-gray-100  rounded-2xl shadow-xl">
                    ...
                    <p className="text-center mx-12 text-gray-500 leading-7">Need to talk to someone? Come have a chat with your therapist!</p></NavLink>
                </div>
                <div className="card-3 py-6 border border-gray-100  rounded-2xl shadow-xl">
                    ...
                    <p className="text-center mx-12 text-gray-500 leading-7">For better experience therapists recommend video calls, but always remember that its a choice!</p></NavLink>
                </div>
            </div>
        </div>
    )
