    ...
    <div className="px-4 sm:px-16 lg:px-[10.25rem] py-24 break-words w-screen">
      ...
      <div className="flex flex-wrap justify-evenly gap-4 items-center text-center my-7">
        <div className="flex flex-col justify-center gap-4 border border-vodka rounded-2xl shadow-xl shadow-vodka/25 w-[23rem] max-w-full min-h-[21.875rem] h-fit">
          ...
          <NavLink
            to="/contact"
            className="text-2xl leading-[2.25rem] text-white bg-lavender-indigo hover:bg-wild-strawberry/70 hover:scale-95 focus:bg-wild-strawberry/70 focus:scale-95 rounded px-[2rem] py-[0.75rem] max-w-full w-fit self-center"
          >
            PURCHASE
          </NavLink>
        </div>
      ...
      <div className="flex flex-col justify-center gap-4 border border-vodka rounded-2xl shadow-vodka/25 shadow-xl mt-[4.4rem] text-center">
